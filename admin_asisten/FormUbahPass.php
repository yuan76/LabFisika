...
$b=mysqli_query($conn,"select*from asisten where id_asis='$a'"); 
...
<tr> <td> Username </td> <td> : </td> <td> <input type="text" name="user" value="<?php echo $c['user_asis']?>" readonly=""/> </td> </tr>
<tr> <td> Password Lama </td> <td> : </td> <td> <input type="password" name="pl" value="<?php echo $c['pass_asis']?>" readonly=""/> </td> </tr>
...
<td> <input type="hidden" name="id" value="<?php echo $c['id_asis']?>"/> </td></tr>
</table>
</form>
</font>
</font>
